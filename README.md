...
Actively exploring decentralized protocols and testing scalable blockchain solutions.
...
### 💻 Technical Stack:
*   **OS:** Windows (Primary), Linux (Learning).
*   **Environment:** Node.js v22, Git, CLI-based tools.
*   **Wallets:** Petra (Aptos), Sui Wallet, 5N ID (Loop).

---
*Meow meow — building the future, one step at a time.* 🐾🦭
